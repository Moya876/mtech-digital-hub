              ...
              <div className="space-y-6">
                ...
                <div className="flex">
                  ...
                  <div>
                    ...
                    <p className="text-mtechGray-700">contact@mtechcorp.com</p>
                  </div>
                </div>
                ...
                <div className="flex">
                  ...
                  <div>
                    ...
                    <p className="text-mtechGray-700">Monday - Friday: 9:00 AM - 5:00 PM</p>
                    <p className="text-mtechGray-700">Saturday & Sunday: Closed</p>
                  </div>
                </div>
              </div>
            </div>
